...
//              HiveProjectMergeRule.INSTANCE, ProjectRemoveRule.INSTANCE); lkl
              HiveProjectMergeRule.INSTANCE, ProjectRemoveRule.INSTANCE, HiveSortMergeRule.INSTANCE);
      perfLogger.PerfLogEnd(this.getClass().getName(), PerfLogger.OPTIMIZER,
//              "Calcite: Prejoin ordering transformation, Merge Project-Project"); lkl
    ...
    private RelNode genGBLogicalPlan(QB qb, RelNode srcRel) throws SemanticException {
      ...
      if (selExprList.getToken().getType() == HiveParser.TOK_SELECTDI
        ...
        if (node.getToken().getType() == HiveParser.TOK_ALLCOLREF) {
          // lkl srcRel = genSelectLogicalPlan(qb, srcRel, srcRel, null,null);
...
//            throws SemanticException { lkl
    private RelNode genOBLogicalPlan(QB qb, Pair<RelNode, RowResolver> selPair,
      ...
      // lkl RelNode originalOBChild = null;
...
//    lkl    outputRel = genUDTFPlan(genericUDTF, genericUDTFName, udtfTableAlias, udtfColAliases, qb, calciteColLst, out_rwsch, srcRel);
//      }
//      else{
//   lkl     outputRel = genSelectRelNode(calciteColLst, out_rwsch, srcRel);
